...
public class LibraryApp {
    ...
    public void addBook() {
        System.out.println("Entry the title:");
        String title = scanner.nextLine();
        System.out.println(" ");
        System.out.println("Entry the author:");
        String author = scanner.nextLine();
        System.out.println(" ");
        System.out.println("Is reading? (Y/N)");
    ...
    public void bookadding() {
        ...
        Book book5= new Book("Harry Potter i Więzień Azkabanu","Rowling", true);
